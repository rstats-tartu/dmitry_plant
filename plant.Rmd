...
```{r}
fc <- read_delim("Fc.csv", delim = ";", locale = locale(decimal_mark = ","))
...
```{r}
ir <- read_delim("Ir.csv", delim = ";", locale = locale(decimal_mark = ","))
...
Morpho - area in mm
```{r}
morpho <- read_delim("Morpho.csv", delim = ";", locale = locale(decimal_mark = ","))
...
weight in grams
```{r}
measure <- read_delim("Measure.csv", delim = ";", locale = locale(decimal_mark = ","))
